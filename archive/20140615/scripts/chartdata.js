...
function initChart(pid) {
    ...
    drawChart(pid, "today", gProds[pid - 1]  + " Article Page Load for Today | URL: " + gArticleURLs[pid - 1], 1,  "chart_today");
    drawChart(pid, "7day", gProds[pid - 1]  + " Article Page Load for the Last 7 Days | URL: " + gArticleURLs[pid - 1], 1, "chart_7day");
