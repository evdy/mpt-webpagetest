...
<?php while($row = mysqli_fetch_array($result)) {?>
        <tr>
            <td><a style="text-decoration: none;" target="_blank" href="http://ec2-54-205-157-244.compute-1.amazonaws.com/results.php?test=<?php echo $row['test id'] ?>"><?php echo $row['test id'] ?></a></td>
