...
<?php while($row = mysqli_fetch_array($result)) {?>
    <table style="width: 100%; font: 14px 'Myriad Pro'; color: #444;">
        <tr style="border-top: 0px solid #999;"> 
            <th style="height: 20px; text-align: left; font: 15px 'Myriad Pro'; color: #000; padding-top: 3px; letter-spacing: 2px;" colspan="19">URL: <a href="<?php echo $row['url'] ?>"><?php echo substr($row['url'], 0, strpos($row['url'] . '?', '?')) ?></a></th>
        </tr>
